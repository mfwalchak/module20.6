...
var searchForm = document.getElementById("searchTerm");
var errorDiv = document.createElement("div"); //check if form is blank
...
function validateSearch(searchForm) {
  ...
  if (!validateExists(searchForm)) {
    ...
    console.log(searchError); // document.getElementById("searchError").className = 
...
var main = function main() {
  ...
  searchBtn.addEventListener("click", function (event) {
    ...
    var searchValue = searchForm.value;
